            ...
            <div style={{
                ...
                {/* <div className="card" style={{ width: "60%", height: "fit-content" }}>
                    <form>
                        <div className="card-body">
                            <h5 className="card-title mb-3 text-center">Signup</h5>
                            <label className="mb-2 form-label"  >First Name</label><input type="text" className="form-control mb-3" value={this.state.firstName} name="firstName" onChange={this.updateFormField} />
                          
                            <label className="mb-2 form-label">Last Name</label><input type="text"  className="form-control mb-3" value={this.state.lastName} name="lastName" onChange={this.updateFormField} />
                            
                            <label className="mb-2 form-label">Username</label><input type="text" className="form-control mb-3" value={this.state.username} name="username"  onChange={this.updateFormField} />
                            
                            <label className="mb-2">Password</label><input type="text" className="form-control mb-3" value={this.state.password} name="password" onChange={this.updateFormField} />
                            <button className="btn btn-sm btn-primary mb-3"  onClick={ () => {
                                 authService.signup(this.state).then(window.location.replace("/"))
